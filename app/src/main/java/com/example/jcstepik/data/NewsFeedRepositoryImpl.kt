...
class NewsFeedRepositoryImpl @Inject constructor(
    ...
    val authStatFlow = flow {
        checkAuthStateEvents.emit(Unit)
        checkAuthStateEvents.collect {
            val currentToken = token
            val loggedIn = currentToken != null && currentToken.isValid
            val authState = if (loggedIn) AuthState.Authorized else AuthState.NonAuthorized
            emit(authState)
        }
    }.stateIn(
    ...
    override fun getAuthStateFlow(): StateFlow<AuthState> =authStatFlow

    override fun getRecommendationsList(): StateFlow<List<FeedPost>> = recommendations
    ...
    override suspend fun changeLikeStatus(feedPost: FeedPost) {
        ...
        val newStatistics = feedPost.statistics.toMutableList().apply {
            ...
            add(StatisticItem(type = StatisticType.LIKE, newLikesCount))
        }
